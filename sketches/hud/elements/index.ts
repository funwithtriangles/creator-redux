  ...
  update({
    ...
    this.border.update({
      params: {
        ...
        miniWaveFormItems: [
          {
            title: params.miniWaveform_title0,
            latestValue: params.miniWaveform_latestValue0,
            pos: params.miniWaveform_pos0,
            width: params.miniWaveform_width0,
            height: params.miniWaveform_height0,
          },
          {
            title: params.miniWaveform_title1,
            latestValue: params.miniWaveform_latestValue1,
            pos: params.miniWaveform_pos1,
            width: params.miniWaveform_width1,
            height: params.miniWaveform_height1,
          },
          {
            title: params.miniWaveform_title2,
            latestValue: params.miniWaveform_latestValue2,
            pos: params.miniWaveform_pos2,
            width: params.miniWaveform_width2,
            height: params.miniWaveform_height2,
          },
        ],
